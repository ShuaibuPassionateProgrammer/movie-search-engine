...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-950 via-blue-950 to-gray-950 flex flex-col">
            <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-7xl flex-1 w-full">
                {/* Header with branding and mode toggler */}
                <header className="flex flex-col sm:flex-row items-center justify-between mb-8 sm:mb-12 gap-4 sm:gap-0">
